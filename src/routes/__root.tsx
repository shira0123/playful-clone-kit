...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Evolve Digital Trade — A.I. Trading & Investment Company" },
      { name: "description", content: "Evolve Digital Trade: an A.I.-powered cryptocurrency trading and investment platform. Trade with confidence, earn passively, and diversify your portfolio." },
      { property: "og:title", content: "Evolve Digital Trade — A.I. Trading & Investment Company" },
      { property: "og:description", content: "Evolve Digital Trade: an A.I.-powered cryptocurrency trading and investment platform. Trade with confidence, earn passively, and diversify your portfolio." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Evolve Digital Trade" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Evolve Digital Trade — A.I. Trading & Investment Company" },
      { name: "twitter:description", content: "Evolve Digital Trade: an A.I.-powered cryptocurrency trading and investment platform. Trade with confidence, earn passively, and diversify your portfolio." },
